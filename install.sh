#!/usr/bin/env bash
# Installs the Bearded Diamond KDE Plasma 6 global theme.
#
...
#
# Usage:
#   ./install.sh                 install color scheme, icons, global theme (user-level)
#   ./install.sh --apply         also apply the global theme immediately
